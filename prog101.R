...
#Temperature anomaly is calculated by subtracting mean seasonal water
#temperature from regional mean for whole time series within each of the five
#time periods.
...
#testing sites. i.e. temp, site name, date/time of temp record, predicted tide
#at time of temp record, etc.
# Link to sketch
https://drive.google.com/file/d/1nZiUA7KtstPrdARVr_bWpKJyKd_Klejc/view?usp=sharing
...
#Extremes reached in air or air/transition exposure on both graphs.
